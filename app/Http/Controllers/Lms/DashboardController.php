...
class DashboardController extends Controller
{
    public function __construct()
    {
        ...
        // $this->middleware('can:dashboard admin', ['only' => ['admin']]);
    ...
    {
         return Inertia::render('Lms/Dashboard/Admin', [
            'can' => [
                'create' => Auth::user()->can('dashboard create'),
                'edit' => Auth::user()->can('dashboard edit'),
                'delete' => Auth::user()->can('dashboard delete'),
            ]
        ]);
    }
